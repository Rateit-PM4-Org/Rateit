...
class RateitAPIRitGetAllITTest extends AbstractBaseIntegrationTest {
    ...
    void setup() throws InterruptedException {
        ...
        ritRepository.saveAll(List.of(
                new Rit("Rit1", "Details1", List.of("tag1"), List.of(1), testUser),
                new Rit("OtherUserRit", "OtherDetails", List.of("tag3"), List.of(3), otherUser)
        ));
        // Simulate a delay to ensure the second rit is created after the first one
        Thread.sleep(1000);
        ritRepository.save(new Rit("Rit2", "Details2", List.of("tag2"), List.of(2), testUser));
    }
